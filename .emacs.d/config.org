...
#+BEGIN_SRC emacs-lisp
  ...
  ;; pyvenv setup
  (setenv "WORKON_HOME" "/home/zdm/anaconda3/envs")
  (setq pyvenv-workon "..")  ; base anaconda environment
  (pyvenv-mode 1)
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;; Automatically scroll R console on input
...
#+begin_src emacs-lisp
  ...
  ;;       ;; Filter agenda for only personal or work items
  ;;       '(("p" . "Personal")
  ;;         ("pa" "Personal agenda"
  ;;          ((agenda ""))
  ;;          ((org-agenda-tag-filter '("+per"))))
  ;;         ("pt" tags "+per")
  ;;         ("l" . "Lab")
  ;;         ("la" "Lab agenda"
  ;;          ((agenda ""))
  ;;          ((org-agenda-tag-filter '("+lab"))))
  ;;         ("lt" tags "+lab")
  ;;         ))

  ;;; Filter by categories for personal, lab
  (setq org-agenda-custom-commands
        ;; Filter agenda for only personal or work items
        '(("p" . "Personal")
          ("pa" "Personal agenda"
           ((agenda ""))
           ((org-agenda-category-filter '("+personal"))))
          ("pt" tags "+personal")
          ("l" . "Lab")
          ("la" "Lab agenda"
           ((agenda ""))
           ((org-agenda-category-filter '("+lab"))))
          ("lt" tags "+lab")
          ))
#+end_src
*** Blogging
    ...
    (setq org-capture-templates
          '(
             ("l"  ; key
              "Lab archive"  ; title
              entry
              (file+datetree "/home/zdm/Lab/Notebook/lab.org")  ; type
              "* %?\n  %i\n")  ; template

             ("L"
              "Lab logistics"
              entry
              (file+headline "/home/zdm/Lab/Notebook/lab.org" "Inbox")
              "* TODO %?\n  %i\n")

             ("e"
              "Lab events"
              entry
              (file+headline "/home/zdm/Lab/Notebook/lab.org" "Events")
              "* %?\n  %i\n")

             ("p"
              "Personal"
              entry
              (file+headline "/home/zdm/Documents/Personal/personal.org" "Inbox")
              "* TODO %?\n  %i\n")))
  #+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;; Change org-refile emacs keybinding since it is overwritten by eyebrowse
...
Add word to dictionary ([[https://stackoverflow.com/questions/22107182/in-emacs-flyspell-mode-how-to-add-new-word-to-dictionary][source]]).
#+begin_src emacs-lisp
  (defun my-save-word ()
    (interactive)
    (let ((current-location (point))
      ...
      (message "Saved '%s' to dictionary." (car word))))
#+end_src
** Temporary files
